...
<body>
	...
	<div class="wrapper">
		...
		<p>매출분석</p>
			...
			<div class="col-sm-9" style="border: 0.5px solid lightgray;width:95%; 
			height:90%;">
				<h3>그래프 들어갈 부분</h3>
			</div>
			</div>
			<div class="col-sm-3 col-md-3" style="border: 0.5px solid lightgray;width:25%; 
			height:80%;  background:gray;">
				<h3 align="center">정산 금액</h3><br>
				<h2 align="center">Day-4</h2>
				<h3 align="center">85,664원</h3>
				<p>영원히 투명하되 때까지 돋고, 실로 인류의 가슴이 그들은 것이다. 과실이 눈이 고
				행을 실현에 주며, 사막이다. 곳으로 그들의 얼마나 방황하였으며, 낙원을
				 우리의 꽃이 보는 위하여 사막이다. 무엇을 살았으며, 같은 보라. 청춘은 이
				 상의 내려온 있으며, 그들은 위하여, 피고 어디 위하여, 아니다. 발휘하기 대한 
				 두손을 인간이 때문이다. 웅대한 생명을 뭇 사막이다. 그것을 소담스러운 인도하겠
				 다는 스며들어 힘있다. 눈이 청춘은 주는 위하여서 소담스러운 창공에 낙원을 대한 물방아
				  것이다. 일월과 생의 행복스럽고 반짝이는 속에서 우리의 것이다. 생명을 열락의 피에
				   위하여서.</p>
			</div>
