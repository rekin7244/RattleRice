			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="nav navbar-nav ml-auto">
						<li class="nav-item active"><a class="nav-link" href="<%=request.getContextPath()+"/memberlist.ad"%>">회원관리</a></li>
...
<%-- 		<form action="<%=request.getContextPath() %>/bisinessSelect.ad">
	...
	<form id="bisinesslist" 
		action="<%=request.getContextPath() %> /bisinesslist.ad" method="post">
	...
	<script>
		function searchCheck(){
			location.href='<%=request.getContextPath()%>/bisinessSelect.ad';
		}
	</script>
</body>
