...
/**
 * Servlet implementation class SearchNoticeBoardServlet
 */
@WebServlet("/searchNoticeBoard.bo")
public class SearchNoticeBoardServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchNoticeBoardServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		limit = 5;
		int listCount = new BoardService().getSearchNoticeListCount(keyword, condition);
